...
The template pins Twenty `v2.30.0` and deploys:

- Twenty server that waits for PostgreSQL before migrations and exposes `/healthz`
...
- [Twenty v2.30.0](https://github.com/twentyhq/twenty/releases/tag/twenty%2Fv2.30.0)
